...
HD_PWD='D:/Quantum/DynamicCircuit-new-/DynamicCircuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sample_Circuit1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sample_Circuit1.tcl
